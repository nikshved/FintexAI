...
from sqlalchemy import String, DateTime, Numeric, func, ForeignKey, Index, Integer, Enum as SQLEnum
...
class Transaction(Base):
    ...
    type: Mapped[TransactionType] = mapped_column(
        SQLEnum(TransactionType, name="transaction_operation_type_enum", native_enum=False),
        nullable=False
    )
    ...
    category: Mapped["Category"] = relationship("Category", back_populates="transactions") # type: ignore
